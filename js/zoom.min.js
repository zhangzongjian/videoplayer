...
(function(e) {
    function u(u) {
		imgNum = e(this).parents(".gallery").find("li:has(a[href])").length;
		if(flag != "img-main" && e(this).find("img").attr("id") == "img-main") {
			imageIndex = imgIndex+1;
			flag = "img-main";
		}
		$(".footText").html(imageIndex+"/"+imgNum);
        function c() {
            function h(e) {
                e.show();
        ...
        var a = e(this);
		if(flag == "img-main" && e(this).find("img").attr("id") == "img-main") {
			for(var x = 1; x<imageIndex; x++)
			{
				a = a.parent().next().find("a");
			}
		}
        f = a.attr("href");
        if (!f) return;
        ...
        n.html(l).delay(1).addClass("loading");
        l.load(c).attr("src", f);
        i = a
    }
    function a() {
        var t = i.parent("li").prev("li");
        if (t.length == 0) return;
		imageIndex--;
        t.find("a").trigger("click");
		if(flag == "img-main") {
			e(".prevImg").trigger("click");
		}
    }
    function f() {
        var t = i.parent("li").next("li");
        if (t.length == 0) return;
		imageIndex++;
        t.children("a").trigger("click");
		if(flag == "img-main") {
			e(".nextImg").trigger("click");
		}
    }
    function l(s) {
	...
	e("body #zoom").remove();
    e("body").append('<div id="zoom"><a class="close"></a><a href="#previous" class="previous"></a><a href="#next" class="next"></a><div class="content loading"></div><div class="foot"><p class="footText"></p></div></div>');
    var t = e("#zoom").hide(),
    n = e("#zoom .content"),
    r = false,
    i = null,
    ...
    o = e(window).height(); (function() {
		...
		e(".zoom, .gallery li a").unbind("click");
